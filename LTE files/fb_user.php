<?php
class User {
	private $dbHost     = "db.soic.indiana.edu";
    private $dbUsername = "i494f17_team31";
    private $dbPassword = "my+sql=i494f17_team31";
    private $dbName     = "i494f17_team31";
	private $userTbl    = 'fb_users';
