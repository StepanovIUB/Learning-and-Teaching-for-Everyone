                        ...
                        <div class="cart">
                                ...
                                <div class="cart_list">
                                        <div class="cart_list_left">
                                                <li><a></a><a>Class Name</a><a></a><a>Dates</a></li>
                                                <?php
                                                joined_list();
                                                ?>
                                        </div>
                                        <!--<div class="con_list_right">
                                                <li><img 
src="https://fhhuqw.by3302.livefilestore.com/y4mCO-GCtnaTEjsSE5cndv_1lkST0z9rsrlfEANmBa4nfXC1Qtc8Hl4riTFFBWr4Lt8oSbWqV1y0jwLs6z_Mqc4HvDH-BEi9tccHS1AcLRWHGXjMeAeFTzjiBffwm6oziACk8J$
                                        </div>-->
                                </div>
                        </div>
                </div>
